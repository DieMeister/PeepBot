...
class TwitchCommands(commands.Cog):  # TODO make the messages embeds?
    ...
    async def ao3(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def pinterest(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def prints(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def socials(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def spotify(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def tiktok(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def twitter(self, ctx) -> None:
        if logic.has_role(logic.data["execute_twitch_commands"], ctx.author.roles):
