...
class TwitchCommands(commands.Cog):  # TODO make the messages embeds?
    ...
    @commands.command()
    async def patreon(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def prints(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def socials(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def spotify(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def tiktok(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def twitter(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def wishlist(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def art(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def brush(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def comms(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def ocs(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def ocmusic(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def pronouns(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
    ...
    @commands.command()
    async def webtoon(self, ctx: discord.ext.commands.Context) -> None:
        if logic.has_property(logic.data["execute_twitch_commands"], ctx.author.roles):
